...
public class PublicationEntityToResource {
    public static PublicationResource toResourceFromEntity(Publication entity){
        return new PublicationResource(entity.getId(),entity.getTitle(),entity.getDescription(),entity.getImages(), entity.getTelephone(),entity.getViews(),entity.getLikes(),entity.getStudent());
    }
}
